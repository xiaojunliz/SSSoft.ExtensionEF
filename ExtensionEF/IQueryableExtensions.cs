...
// ***********************************************************************
// <copyright file="IQueryableExtensions.cs" company="赛思网络科技">
...
namespace HySoft.Core.Framework
{
    ...
    public static class IQueryableExtensions
    {
        ...
        /// <summary>
        /// Selects the partially.
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="source">The source.</param>
        /// <param name="propertyNames">The property names.</param>
        /// <returns>IQueryable{dynamic}.</returns>
        /// <exception cref="System.ArgumentNullException">Source Object is NULL</exception>
        ...
        {
            /// <summary>
            /// The _parameter expression
            /// </summary>
            private ParameterExpression _parameterExpression;
            /// <summary>
            /// The _parameter expression to replace
            /// </summary>
            ...
            /// <param name="parameterExpressionToReplace">The parameter expression to replace.</param>
